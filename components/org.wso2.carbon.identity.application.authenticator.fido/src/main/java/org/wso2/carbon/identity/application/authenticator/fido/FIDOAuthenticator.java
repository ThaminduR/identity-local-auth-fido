...
public class FIDOAuthenticator extends AbstractApplicationAuthenticator
     ...
     * @param context           AuthenticationContext.
     * @param authenticatedUser AuthenticatedUser.
     * @throws AuthenticationFailedException If an error occurred while validating the userstore domain. 1Code has comments. Press enter to view.
     ...
     * @param context AuthenticationContext.
     * @param user    AuthenticatedUser.
     * @throws AuthenticationFailedException If an error occurs during normalization. 1Code has comments. Press enter to view.
